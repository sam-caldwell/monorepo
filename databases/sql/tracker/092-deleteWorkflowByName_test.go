...
func TestSqlDbFunc_deleteWorkflowByName(t *testing.T) {
	//const (
	...
	//	expectedFirstName    = "Orville"
	//	expectedLastName     = "Wright"
	//	expectedEmail        = "orville.wright@example.com"
	//	expectedPhone        = "003.003.0003"
	//	expectedDescription  = "Test description"
	//	expectedTeamName     = "WriteBrothersFlying2"
	//	expectedWorkflowName = "KittyHawk2"
	//)
	...
	//	var rows *sql.Rows
	//	var err error
	//	rows, err = db.Query("select deleteWorkflowByName('%s');", expectedWorkflowName)
	//	if err != nil {
	//		t.Fatal(err)
	//	}
	//	defer func() { _ = rows.Close() }()
	...
	//	var rows *sql.Rows
	//	var err error
	//	rows, err = db.Query("select count(*) from workflow where name='%s';", expectedWorkflowName)
	//	if err != nil {
	//		t.Fatal(err)
	//	}
	//	defer func() { _ = rows.Close() }()
