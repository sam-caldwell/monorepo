...
func TestSqlDbFunc_getTicketTypes(t *testing.T) {
	...
	t.Run("get the ticket", func(t *testing.T) {
		...
		rows, err = db.Query("select getTicketTypes(10,0);")
		if err != nil {
