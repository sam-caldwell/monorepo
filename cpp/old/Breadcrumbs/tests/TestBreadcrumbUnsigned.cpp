/**
 * @name Breadcrumbs/tests/TestBreadcrumbUnsigned.cpp
...
class TestBreadcrumbUnsigned : public TestBase {
public:
    /**
     ...
     */
    TestBreadcrumbUnsigned(string n) { name = n; }

    /**
     * @name Class destructor
     * @brief clean up
     */
    ~TestBreadcrumbUnsigned() {}

    bool test_push_count() {
        debug(name + "::test_push_count()");
        Breadcrumbs<unsigned> tags;
        return expect(tags.push(0), "push tag") &&
