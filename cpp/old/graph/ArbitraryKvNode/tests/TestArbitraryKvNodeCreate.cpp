 ...
 */
#include <iostream>
#include "../src/ArbitraryKvNode.h"

#define KEY_PREFIX (string)("test_")


class TestArbitraryKvNodeCreate : public TestBase {
public:
    TestArbitraryKvNodeCreate(string n) { name = n; }
    ...
    bool test_node_create_bool(bool n) {
        ...
        ArbitraryKvNode node("test_node_create_bool", n);
    ...
    bool test_node_create_double(double n) {
        ...
        ArbitraryKvNode node("test_node_create_double", n);
    ...
    bool test_node_create_float(float n) {
        ...
        ArbitraryKvNode node("test_node_create_float", n);
    ...
    bool test_node_create_int(int n) {
        ...
        ArbitraryKvNode node("test_node_create_int", n);
    ...
    bool test_node_create_string(string n) {
        ...
        ArbitraryKvNode node("test_node_create_string", n);
    ...
    bool test_node_create_uint(uint n) {
        ...
        ArbitraryKvNode node("test_node_create_uint", n);
