/**
 * @name ArbitraryValue/tests/TestArbitraryValueSetFloatGetDouble.cpp
...
class TestArbitraryValueSetFloatGetDouble : public TestBase {
public:
    /**
     ...
     */
    TestArbitraryValueSetFloatGetDouble(string n) { name = n; }

    /**
     * @name Class destructor
     * @brief clean up
     */
    ~TestArbitraryValueSetFloatGetDouble() {}
    ...
    bool main() {
        ...
        return expect(test_func(0.0, 0.0), "Given float(0) expect matching double.") &&
               expect(test_func(1.0, 1.0), "Given float(1) expect matching double.") &&
               expect(test_func(pi, pi), "Given float(pi) expect matching double.") &&
               expect(test_func(-pi, -pi), "Given float(-pi) expect matching double.") &&
