/**
 * @name Logger/tests/TestLoggerSyslogWriter.cpp
...
#include "validateLine.cpp"
#include "../src/Logger.h"
#include "../../../../Tester/Mocks/MockFile.h"

class TestLoggerSyslogWriter : public TestBase {
private:
...
public:
     ...
     * @param n
     */
    TestLoggerSyslogWriter(string n) {
        name = n;
        thisWriter = Logging::Writer::syslog;
        destination = "syslog://127.0.0.1:514";
    }
