/**
 * @name Logger/tests/TestLoggerNullWriter.cpp
...
class TestLoggerNullWriter : public TestBase {
private:
...
public:
     ...
     * @param n
     */
    TestLoggerNullWriter(string n) {
        name = n;
        thisWriter = Logging::Writer::null;
    }
    ...
    bool scenario(Logging::Severity sev1, Logging::Severity sev2, bool writeFlag = true) {
        ...
        return expect(logContext.write(sev2, &msg) == writeFlag, "Expected writeOutcome ok");
    }
