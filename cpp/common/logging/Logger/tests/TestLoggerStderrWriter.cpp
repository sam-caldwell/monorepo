/**
 * @name Logger/tests/TestLoggerStderrWriter.cpp
...
#include "../../../../Tester/Mocks/MockStdErr.h"
#include "validateLine.cpp"

class TestLoggerStderrWriter : public TestBase {
private:
...
public:
     ...
     * @param n
     */
    TestLoggerStderrWriter(string n) {
        name = n;
        thisWriter = Logging::Writer::stderr;
    }
