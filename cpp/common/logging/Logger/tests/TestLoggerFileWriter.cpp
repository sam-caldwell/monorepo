/**
 * @name Logger/tests/TestLoggerFileWriter.cpp
...
class TestLoggerFileWriter : public TestBase {
private:
...
public:
     ...
     * @param n
     */
    TestLoggerFileWriter(string n) {
        name = n;
        thisWriter = Logging::Writer::file;
        destination = "test.log.txt";
    }
