...
if(CMAKE_GO_COMPILER)
    debug("CMAKE_GO_COMPILER is already set")
else()
    ...
    set(GO_BIN_PATH $ENV{GOPATH} $ENV{GOROOT} $ENV{GOROOT}/../bin $ENV{GO_COMPILER} /usr/bin /usr/local/bin)
    ...
    if(CMAKE_GO_COMPILER_INIT)
        ...
        debug("The Golang compiler is ${VERSION}")
        debug("Verify compiler: ${CMAKE_GO_COMPILER}")
    endif()
...
configure_file(${CMAKE_CURRENT_SOURCE_DIR}/cmake/CustomModules/CMakeGoCompiler.cmake.in
